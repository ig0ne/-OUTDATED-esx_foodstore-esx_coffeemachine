...
function Menu:drawButtons(options)
	...
	for id, settings in pairs(Menu.GUI) do
		...
		if(settings["active"]) then
			DrawRect(options.x,y,options.width,options.height,208,208,208,255)
		else
			DrawRect(options.x,y,options.width,options.height,241,241,241,255)
		end
